...
public class AuthRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith(Constants.BEARER_TOKEN_PREFIX)) {
            ...
            try {
                ...
                if (username != null && profile != null) {
                    UserDetailsService userDetailsService = profileServiceSelector.selectService(Profile.valueOf(profile));
