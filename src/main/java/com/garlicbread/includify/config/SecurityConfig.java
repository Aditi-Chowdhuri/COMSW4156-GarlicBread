...
public class SecurityConfig {
    ...
    public SecurityConfig(OrganisationDetailsService organisationDetailsService, VolunteerDetailsService volunteerDetailsService, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                .requestMatchers(Constants.NO_AUTH_ENDPOINTS).permitAll()
    ...
    @Primary
    public AuthenticationManager organisationAuthenticationManager(HttpSecurity http) throws Exception {
